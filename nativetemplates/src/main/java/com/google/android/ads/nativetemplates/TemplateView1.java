...
public class TemplateView1 extends FrameLayout {

  private int templateType;
  private NativeTemplateStyle1 styles;
  ...
  public TemplateView1(Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    initView(context, attrs);
  }

  public TemplateView1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    initView(context, attrs);
  }

  @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
  public TemplateView1(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    super(context, attrs, defStyleAttr, defStyleRes);
    initView(context, attrs);
  }

  public void setStyles(NativeTemplateStyle1 styles) {
    this.styles = styles;
    this.applyStyles();
  }
  ...
  private void initView(Context context, AttributeSet attributeSet) {
    ...
    TypedArray attributes =
        context.getTheme().obtainStyledAttributes(attributeSet, R.styleable.TemplateView1, 0, 0);

    try {
      templateType =
          attributes.getResourceId(
              R.styleable.TemplateView1_gnt_template_type, R.layout.gnt_medium_template_view);
    } finally {
      attributes.recycle();
    }
